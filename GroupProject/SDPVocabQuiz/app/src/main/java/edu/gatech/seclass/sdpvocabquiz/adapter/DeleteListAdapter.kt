...
class DeleteListAdapter(private val activity: Activity,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        rowView.txt_list_sub_element.text = "Delete: " + quizzes[position].name
        rowView.setOnClickListener {
            db.dropQuiz(quizzes[position])
            QuizMaster.showDeleteList(activity)
        }
        return rowView
    }

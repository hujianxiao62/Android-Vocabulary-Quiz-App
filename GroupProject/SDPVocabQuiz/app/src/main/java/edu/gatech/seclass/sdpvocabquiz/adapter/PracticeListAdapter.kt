...
import edu.gatech.seclass.sdpvocabquiz.activity.PracticeActvity
...
class PracticeListAdapter(private val activity: Activity,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        rowView.txt_list_sub_element.text = "Practice: " + quizzes[position].name
        rowView.setOnClickListener { QuizMaster.showPracticeQuiz(activity, quizzes[position]) }
        return rowView
    }
